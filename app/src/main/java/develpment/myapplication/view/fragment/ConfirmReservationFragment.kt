 ...
 * Use the [ConfirmReservationFragment.newInstance] factory method to
...
class ConfirmReservationFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ConfirmReservationFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ConfirmReservationFragment().apply {
